 ...
 */var x={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};function P(e){switch(e){case x.RAW:case x.BASE64:case x.BASE64URL:case x.DATA_URL:return;default:throw"Expected one of the event types: ["+x.RAW+", "+x.BASE64+", "+x.BASE64URL+", "+x.DATA_URL+"]."}}var D=function(){function e(e,t){this.data=e,this.contentType=t||null}return e}();function I(e,t){switch(e){case x.RAW:return new D(L(t));case x.BASE64:case x.BASE64URL:return new D(B(e,t));case x.DATA_URL:return new D(F(t),G(t))}throw d()}function L(e){for(var t=[],r=0;r<e.length;r++){var n=e.charCodeAt(r);if(n<=127)t.push(n);else if(n<=2047)t.push(192|n>>6,128|63&n);else if(55296===(64512&n)){var o=r<e.length-1&&56320===(64512&e.charCodeAt(r+1));if(o){var i=n,a=e.charCodeAt(++r);n=65536|(1023&i)<<10|1023&a,t.push(240|n>>18,128|n>>12&63,128|n>>6&63,128|63&n)}else t.push(239,191,189)}else 56320===(64512&n)?t.push(239,191,189):t.push(224|n>>12,128|n>>6&63,128|63&n)}return new Uint8Array(t)}function M(e){var t;try{t=decodeURIComponent(e)}catch(r){throw k(x.DATA_URL,"Malformed data URL.")}return L(t)}function B(e,t){switch(e){case x.BASE64:var r=-1!==t.indexOf("-"),n=-1!==t.indexOf("_");if(r||n){var o=r?"-":"_";throw k(e,"Invalid character '"+o+"' found: is it base64url encoded?")}break;case x.BASE64URL:var i=-1!==t.indexOf("+"),a=-1!==t.indexOf("/");if(i||a){o=i?"+":"/";throw k(e,"Invalid character '"+o+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}var s;try{s=atob(t)}catch(l){throw k(e,"Invalid character found")}for(var u=new Uint8Array(s.length),c=0;c<s.length;c++)u[c]=s.charCodeAt(c);return u}var j=function(){function e(e){this.base64=!1,this.contentType=null;var t=e.match(/^data:([^,]+)?,/);if(null===t)throw k(x.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");var r=t[1]||null;null!=r&&(this.base64=q(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-";base64".length):r),this.rest=e.substring(e.indexOf(",")+1)}return e}();function F(e){var t=new j(e);return t.base64?B(x.BASE64,t.rest):M(t.rest)}function G(e){var t=new j(e);return t.contentType}function q(e,t){var r=e.length>=t.length;return!!r&&e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Be(e){if(!e)throw d()}function je(e,t){function r(r,n){var o=Oe(e,n,t);return Be(null!==o),o}return r}function Fe(e,t){function r(r,n){var o=Ie(e,t,n);return Be(null!==o),o}return r}function Ge(e,t){function r(r,n){var o=Oe(e,n,t);return Be(null!==o),Se(o,n)}return r}function qe(e){function t(t,r){var n;return n=401===t.getStatus()?b():402===t.getStatus()?v(e.bucket):403===t.getStatus()?g(e.path):r,n.setServerResponseProp(r.serverResponseProp()),n}return t}function ze(e){var t=qe(e);function r(r,n){var o=t(r,n);return 404===r.getStatus()&&(o=_(e.path)),o.setServerResponseProp(n.serverResponseProp()),o}return r}function He(e,t,r){var n=t.fullServerUrl(),o=ve(n),i="GET",a=e.maxOperationRetryTime,s=new Me(o,i,je(e,r),a);return s.errorHandler=ze(t),s}function Ve(e,t,r,n,o){var i={};t.isRoot?i["prefix"]="":i["prefix"]=t.path+"/",r&&r.length>0&&(i["delimiter"]=r),n&&(i["pageToken"]=n),o&&(i["maxResults"]=o);var a=t.bucketOnlyServerUrl(),s=ve(a),u="GET",c=e.maxOperationRetryTime,l=new Me(s,u,Fe(e,t.bucket),c);return l.urlParams=i,l.errorHandler=qe(t),l}function We(e,t,r){var n=t.fullServerUrl(),o=ve(n),i="GET",a=e.maxOperationRetryTime,s=new Me(o,i,Ge(e,r),a);return s.errorHandler=ze(t),s}function Xe(e,t,r,n){var o=t.fullServerUrl(),i=ve(o),a="PATCH",s=Te(r,n),u={"Content-Type":"application/json; charset=utf-8"},c=e.maxOperationRetryTime,l=new Me(i,a,je(e,n),c);return l.headers=u,l.body=s,l.errorHandler=ze(t),l}function Ke(e,t){var r=t.fullServerUrl(),n=ve(r),o="DELETE",i=e.maxOperationRetryTime;function a(e,t){}var s=new Me(n,o,a,i);return s.successCodes=[200,204],s.errorHandler=ze(t),s}function Je(e,t){return e&&e["contentType"]||t&&t.type()||"application/octet-stream"}function Ze(e,t,r){var n=Object.assign({},r);return n["fullPath"]=e.path,n["size"]=t.size(),n["contentType"]||(n["contentType"]=Je(null,t)),n}function $e(e,t,r,n,o){var i=t.bucketOnlyServerUrl(),a={"X-Goog-Upload-Protocol":"multipart"};function s(){for(var e="",t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}var u=s();a["Content-Type"]="multipart/related; boundary="+u;var c=Ze(t,n,o),l=Te(c,r),h="--"+u+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+l+"\r\n--"+u+"\r\nContent-Type: "+c["contentType"]+"\r\n\r\n",f="\r\n--"+u+"--",p=le.getBlob(h,n,f);if(null===p)throw R();var d={name:c["fullPath"]},_=ve(i),v="POST",b=e.maxUploadRetryTime,g=new Me(_,v,je(e,r),b);return g.urlParams=d,g.headers=a,g.body=p.uploadData(),g.errorHandler=qe(t),g}var Qe=function(){function e(e,t,r,n){this.current=e,this.total=t,this.finalized=!!r,this.metadata=n||null}return e}();function Ye(e,t){var r=null;try{r=e.getResponseHeader("X-Goog-Upload-Status")}catch(o){Be(!1)}var n=t||["active"];return Be(!!r&&-1!==n.indexOf(r)),r}function et(e,t,r,n,o){var i=t.bucketOnlyServerUrl(),a=Ze(t,n,o),s={name:a["fullPath"]},u=ve(i),c="POST",l={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":n.size(),"X-Goog-Upload-Header-Content-Type":a["contentType"],"Content-Type":"application/json; charset=utf-8"},h=Te(a,r),f=e.maxUploadRetryTime;function p(e){var t;Ye(e);try{t=e.getResponseHeader("X-Goog-Upload-URL")}catch(r){Be(!1)}return Be(ee(t)),t}var d=new Me(u,c,p,f);return d.urlParams=s,d.headers=l,d.body=h,d.errorHandler=qe(t),d}function tt(e,t,r,n){var o={"X-Goog-Upload-Command":"query"};function i(e){var t=Ye(e,["active","final"]),r=null;try{r=e.getResponseHeader("X-Goog-Upload-Size-Received")}catch(i){Be(!1)}r||Be(!1);var o=Number(r);return Be(!isNaN(o)),new Qe(o,n.size(),"final"===t)}var a="POST",s=e.maxUploadRetryTime,u=new Me(r,a,i,s);return u.headers=o,u.errorHandler=qe(t),u}var rt=262144;function nt(e,t,r,n,o,i,a,s){var u=new Qe(0,0);if(a?(u.current=a.current,u.total=a.total):(u.current=0,u.total=n.size()),n.size()!==u.total)throw A();var c=u.total-u.current,l=c;o>0&&(l=Math.min(l,o));var h=u.current,f=h+l,p=l===c?"upload, finalize":"upload",d={"X-Goog-Upload-Command":p,"X-Goog-Upload-Offset":u.current},_=n.slice(h,f);if(null===_)throw R();function v(e,r){var o,a=Ye(e,["active","final"]),s=u.current+l,c=n.size();return o="final"===a?je(t,i)(e,r):null,new Qe(s,c,"final"===a,o)}var b="POST",g=t.maxUploadRetryTime,y=new Me(r,b,v,g);return y.headers=d,y.body=_.uploadData(),y.progressCallback=s||null,y.errorHandler=qe(e),y}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var L=function(e){var t={},r={},n={},o="";try{var i=e.split(".");t=D(h(i[0])||""),r=D(h(i[1])||""),o=i[2],n=r["d"]||{},delete r["d"]}catch(a){}return{header:t,claims:r,data:n,signature:o}},M=function(e){var t=L(e).claims,r=Math.floor((new Date).getTime()/1e3),n=0,o=0;return"object"===typeof t&&(t.hasOwnProperty("nbf")?n=t["nbf"]:t.hasOwnProperty("iat")&&(n=t["iat"]),o=t.hasOwnProperty("exp")?t["exp"]:n+86400),!!r&&!!n&&!!o&&r>=n&&r<=o},B=function(e){var t=L(e).claims;return"object"===typeof t&&t.hasOwnProperty("iat")?t["iat"]:null},j=function(e){var t=L(e),r=t.claims;return!!r&&"object"===typeof r&&r.hasOwnProperty("iat")},F=function(e){var t=L(e).claims;return"object"===typeof t&&!0===t["admin"]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var oe=function(e){for(var t=[],r=0,n=0;n<e.length;n++){var o=e.charCodeAt(n);if(o>=55296&&o<=56319){var a=o-55296;n++,i(n<e.length,"Surrogate pair missing trail surrogate.");var s=e.charCodeAt(n)-56320;o=65536+(a<<10)+s}o<128?t[r++]=o:o<2048?(t[r++]=o>>6|192,t[r++]=63&o|128):o<65536?(t[r++]=o>>12|224,t[r++]=o>>6&63|128,t[r++]=63&o|128):(t[r++]=o>>18|240,t[r++]=o>>12&63|128,t[r++]=o>>6&63|128,t[r++]=63&o|128)}return t},ie=function(e){for(var t=0,r=0;r<e.length;r++){var n=e.charCodeAt(r);n<128?t++:n<2048?t+=2:n>=55296&&n<=56319?(t+=4,r++):t+=3}return t},ae=1e3,se=2,ue=144e5,ce=.5;function le(e,t,r){void 0===t&&(t=ae),void 0===r&&(r=se);var n=t*Math.pow(r,e),o=Math.round(ce*n*(Math.random()-.5)*2);return Math.min(ue,n+o)}t.CONSTANTS=o,t.Deferred=d,t.ErrorFactory=U,t.FirebaseError=k,t.MAX_VALUE_MILLIS=ue,t.RANDOM_FACTOR=ce,t.Sha1=X,t.areCookiesEnabled=C,t.assert=i,t.assertionError=a,t.async=Z,t.base64=c,t.base64Decode=h,t.base64Encode=l,t.calculateBackoffMillis=le,t.contains=G,t.createSubscribe=K,t.decode=L,t.deepCopy=f,t.deepExtend=p,t.errorPrefix=ee,t.getUA=_,t.isAdmin=F,t.isBrowser=g,t.isBrowserExtension=y,t.isElectron=E,t.isEmpty=z,t.isIE=w,t.isIndexedDBAvailable=S,t.isMobileCordova=v,t.isNode=b,t.isNodeSdk=A,t.isReactNative=m,t.isSafari=O,t.isUWP=R,t.isValidFormat=j,t.isValidTimestamp=M,t.issuedAtTime=B,t.jsonEval=D,t.map=H,t.querystring=V,t.querystringDecode=W,t.safeGet=q,t.stringLength=ie,t.stringToByteArray=oe,t.stringify=I,t.validateArgCount=Y,t.validateCallback=re,t.validateContextObject=ne,t.validateIndexedDBOpenable=T,t.validateNamespace=te}).call(this,r("c8ba"))}}]);